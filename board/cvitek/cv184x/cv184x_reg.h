#ifndef __CV184X_REG_H__
#define __CV184X_REG_H__
...
#endif
#define AXI_SRAM_BASE        (TPU_SRAM_ORIGIN_BASE + TPU_SRAM_SIZE)
...
#define HSPERI_COMMON_REG 0x0E000000
...
#define TIME_RECORDS_ADDR (AXI_SRAM_BASE + 0x1C) // 0x0C0C701C

/* from fsbl/plat/cv184x/include/platform_def.h struct _time_records { ... } */
