...
#define CONSOLE_OEM_INFO   (OEM_INFO_RTC_SRAM_ADDR + 0x82) //1byte for console selsect
#define CONSOLE_USE_UART0  (0x00)
#define CONSOLE_USE_UART2  (0x02)
#define DTSTYPE_OEM_INFO   (OEM_INFO_RTC_SRAM_ADDR + 0xA0) //32byte for dts type
#define DDR_SIZE_OEM_INFO   (OEM_INFO_RTC_SRAM_ADDR + 0xF0) //32byte for ddr size
...
#define TIME_RECORDS_FIELD_UBOOT_START (TIME_RECORDS_ADDR + 0xc)
#define TIME_RECORDS_FIELD_BOOTCMD_START (TIME_RECORDS_ADDR + 0xe)
#define TIME_RECORDS_FIELD_DECOMPRESS_KERNEL_START (TIME_RECORDS_ADDR + 0x10)
#define TIME_RECORDS_FIELD_KERNEL_START (TIME_RECORDS_ADDR + 0x12)
