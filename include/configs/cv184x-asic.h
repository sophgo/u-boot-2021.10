...
#ifndef __CV184X_ASIC_H__
#define __CV184X_ASIC_H__

#include <../../../board/cvitek/cv184x/cv184x_reg.h>
...
#define UPGRADE_SRAM_ADDR    (AXI_SRAM_BASE + 0x30)
#define UBOOT_PID_SRAM_ADDR  (AXI_SRAM_BASE + 0x30)
#define UPDATE_ADDR	CVIMMAP_UIMAG_ADDR
...
/*******************************************************************************/
	...
	#if defined(__riscv)
		#define RISCV_OPENSBI_FWSIZE " riscv.fwsz=0x80000 "
	#else
		#define RISCV_OPENSBI_FWSIZE " "
	#endif
