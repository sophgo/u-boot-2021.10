...
#define RST_AUTO_CLEAR_CPUCORE0	(8 * 32)
#define RST_AUTO_CLEAR_CPUCORE1	(RST_AUTO_CLEAR_CPUCORE0 + 1)
#define RST_AUTO_CLEAR_CPUCORE2	(RST_AUTO_CLEAR_CPUCORE0 + 2)
#define RST_AUTO_CLEAR_CPUCORE3	(RST_AUTO_CLEAR_CPUCORE0 + 3)
#define RST_AUTO_CLEAR_MAINRST_AP	(RST_AUTO_CLEAR_CPUCORE0 + 4)
#define RST_AUTO_CLEAR_SECONDRST_AP	(RST_AUTO_CLEAR_CPUCORE0 + 5)

#define RST_CPUCORE0	(9 * 32)
#define RST_CPUCORE1	(RST_CPUCORE0 + 1)
#define RST_CPUCORE2	(RST_CPUCORE0 + 2)
#define RST_CPUCORE3	(RST_CPUCORE0 + 3)
#define RST_CPUSYS0 (RST_CPUCORE0 + 4)
#define RST_CPUSYS1 (RST_CPUCORE0 + 5)
#define RST_CPUSYS2 (RST_CPUCORE0 + 6)
