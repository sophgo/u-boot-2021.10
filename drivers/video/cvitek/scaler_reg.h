...
#define REG_SCL_DISP_BASE 0x0A094000
#define REG_SCL_TOP_BASE 0x0A0A8000
#define REG_VO_MAC_BASE 0x0A0A8000
#define REG_SCL_DSI_BASE 0x0A099000
#define REG_DSI_WRAP_BASE 0x0A098000
...
//vo mux
#define REG_SCL_TOP_VO_MUX (REG_VO_MAC_BASE + 0x70)
#define REG_SCL_TOP_VO_MUX0 (REG_VO_MAC_BASE + 0x90)
#define REG_SCL_TOP_VO_MUX1 (REG_VO_MAC_BASE + 0x94)
#define REG_SCL_TOP_VO_MUX2 (REG_VO_MAC_BASE + 0x98)
#define REG_SCL_TOP_VO_MUX3 (REG_VO_MAC_BASE + 0x9C)
#define REG_SCL_TOP_VO_MUX4 (REG_VO_MAC_BASE + 0xA0)
#define REG_SCL_TOP_VO_MUX5 (REG_VO_MAC_BASE + 0xA4)
#define REG_SCL_TOP_VO_MUX6 (REG_VO_MAC_BASE + 0xA8)
#define REG_SCL_TOP_VO_MUX7 (REG_VO_MAC_BASE + 0xAC)
#define REG_SCL_TOP_VO_MUX8 (REG_VO_MAC_BASE + 0xB0)
#define REG_SCL_TOP_VO_MUX9 (REG_VO_MAC_BASE + 0xB4)
#define REG_SCL_TOP_VO_MUXA (REG_VO_MAC_BASE + 0xB8)
...
#define REG_SCL_DISP_RD_TH_Y_MSB (REG_SCL_DISP_BASE + 0x2c)
#define REG_SCL_DISP_FIFO_TH (REG_SCL_DISP_BASE + 0x30)
...
#define REG_SCL_DISP_DUMMY1 (REG_SCL_DISP_BASE + 0xFC)
#define REG_SCL_DISP_LINE_BUFFER_SERIAL (REG_SCL_DISP_BASE + 0x3A4)

// INT
#define REG_SCL_DISP_DEBUG_STATUS (REG_SCL_DISP_BASE + 0x370)
#define REG_SCL_DISP_INT_SEL (REG_SCL_DISP_BASE + 0x374)
#define REG_SCL_DISP_INT_CLR (REG_SCL_DISP_BASE + 0x378)
...
// i80
#define REG_SCL_DISP_MCU_IF_CTRL (REG_VO_MAC_BASE + 0x20)
#define REG_SCL_DISP_MCU_SW_CTRL (REG_VO_MAC_BASE + 0x24)
#define REG_SCL_DISP_MCU_STATUS (REG_VO_MAC_BASE + 0x28)
#define REG_SCL_DISP_MCU_INT_STATUS (REG_VO_MAC_BASE + 0x2c)
#define REG_SCL_DISP_MCU_HW_AUTO (REG_VO_MAC_BASE + 0x30)
#define REG_SCL_DISP_MCU_HW_CMD (REG_VO_MAC_BASE + 0x34)
#define REG_SCL_DISP_MCU_HW_CMD0 (REG_VO_MAC_BASE + 0x38)
#define REG_SCL_DISP_MCU_HW_CMD1 (REG_VO_MAC_BASE + 0x3C)
#define REG_SCL_DISP_MCU_HW_CMD2 (REG_VO_MAC_BASE + 0x40)
#define REG_SCL_DISP_MCU_HW_CMD3 (REG_VO_MAC_BASE + 0x44)
#define REG_SCL_DISP_MCU_HW_CMD4 (REG_VO_MAC_BASE + 0x48)
#define REG_SCL_DISP_MCU_HW_CMD5 (REG_VO_MAC_BASE + 0x4C)
#define REG_SCL_DISP_MCU_HW_CMD6 (REG_VO_MAC_BASE + 0x50)
#define REG_SCL_DISP_MCU_HW_CMD7 (REG_VO_MAC_BASE + 0x54)
#define REG_SCL_DISP_MCU_HW_SW_OV(x) (REG_VO_MAC_BASE + 0x58)
...
#define REG_SCL_LVDSTX_MAC (REG_SCL_DSI_BASE + 0x30)
