...
const struct flash_info spi_nor_ids[] = {
	...
	{ INFO("W25Q64JV-IQ", 0xef4017, 0x0, 64 * 1024, 128,
		SPI_NOR_QUAD_READ | SECT_4K) },
	{ INFO("W25Q512JV", 0xef4020, 0x0, 64 * 1024, 1024,
		SPI_NOR_QUAD_READ | SECT_4K | SPI_NOR_4B_OPCODES) },
	{ INFO("GD25Q128E/H", 0xc84018, 0x0, 64 * 1024, 256,
		SPI_NOR_QUAD_READ | SECT_4K) },
	...
	{ INFO("P25Q64SH", 0x856017, 0x0, 64 * 1024, 128,
		SPI_NOR_QUAD_READ | SECT_4K) },
	{ INFO("P25D32SH", 0x856016, 0x0, 64 * 1024, 64,
		SPI_NOR_DUAL_READ | SECT_4K) },
	...
	{ INFO("UC25IQ128", 0xB34018, 0x0, 64 * 1024, 256,
		SPI_NOR_QUAD_READ | SECT_4K) },
	{ INFO("XTD25W64A", 0x0B7517, 0x0, 64 * 1024, 128,
		SPI_NOR_QUAD_READ | SECT_4K) },
	{ },
};
