...
#define PHY_READ(a,b)  phy_read((a),MDIO_DEVAD_NONE,(b))
#define PHY_WRITE(a,b,c)  phy_write((a),MDIO_DEVAD_NONE,(b),(c))
...
static int maxio_mae0621aq3ci_config_init(struct phy_device *phydev)
{
	...
	// add tx/rx delay
	ret |= maxio_write_paged(phydev, 0xda1, 0x17, 0xf0);
...
static struct phy_driver MAXIO_MAE0621A_driver = {
	...
	.config = &maxio_mae0621a_config_init,
	.startup = &maxio_mae0621a_resume,
	.shutdown = &maxio_mae0621a_suspend,
};

static struct phy_driver MAXIO_MAE0621AQ3CI_driver = {
	.name = "MAE0621A/B-Q3C(I) Gigabit Ethernet",
	.uid = 0x7b744412,
	.mask = 0x7fffffff,
	.features = PHY_GBIT_FEATURES ,
	.config = &maxio_mae0621aq3ci_config_init,
	.probe = &maxio_mae0621aq3ci_probe,
	.startup = &maxio_mae0621aq3ci_resume,
	.shutdown = &maxio_mae0621aq3ci_suspend,
...
int phy_maxio_init(void)
{
	...
	phy_register(&MAXIO_MAE0621AQ3CI_driver);
